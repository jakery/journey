...
define('JakesJourney', ['./DeathMessages', './TileCodes', './Coordinates', './Sprite', './Keyboard', './Utility', './ObscurelyNamedFile', './Draw'],
  (DeathMessages, TileCodes, Coordinates, Sprite, Keyboard, ObscurelyNamedFile, Utility, Draw) => {
    const $j = $.noConflict();
